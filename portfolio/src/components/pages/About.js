...
const About = () => (
  <div>
    ...
    <img width="640" src={picone} alt="jake1" />
    <img width="640" src={pictwo} alt="jake2" />
    <img width="640" src={picthree} alt="jake3" />
    <img width="640" src={picfour} alt="jake4" />
    <img width="640" src={picfive} alt="jake5" />
